	...
	for(;;)
	{
		...
		{	
			...
			if(256 <= i && i <= 511)
			{
				...
				if(i < 256 + 0x54)
				{
					if(keytable[i - 256] != 0)
					{
						s[0] = keytable[i-256];
						s[1] = 0;
						puttext8_sht(sht_win, cursor_x, 28, COL8_000000, COL8_FFFFFF, s, 1);
						cursor_x += 8;
					}
				}
				if(i == 256 + 0x0e && cursor_x > 8)
				{
					puttext8_sht(sht_win, cursor_x, 28, COL8_000000, COL8_FFFFFF, " ", 1);
					cursor_x -= 8;
				}
			...
			else if(i == 10)
			{
				...
				//puttext8_sht(sht_win, 40, 28, COL8_000000, COL8_C6C6C6, s, 10);
			}
			else if(i == 3)
			{
